...
class VerifyCertificatePageController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        $content = $request->validate([
            ...
            'content.result.field_labels.particulars' => ['nullable', 'string', 'max:80'],
            'content.result.field_labels.natural_faces' => ['nullable', 'string', 'max:80'],
            'content.result.field_labels.artificial_faces' => ['nullable', 'string', 'max:80'],
            'content.result.field_labels.test_carried_out' => ['nullable', 'string', 'max:80'],
            'content.result.field_labels.xray_results' => ['nullable', 'string', 'max:80'],
            'content.result.field_labels.conclusions' => ['nullable', 'string', 'max:80'],
            'content.result.field_labels.genus_type' => ['nullable', 'string', 'max:80'],
